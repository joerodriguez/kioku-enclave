...
| `verify_release_metadata.py` | Strict schema-v6 validator for the GitHub-signed release-manifest subject: binds source/tag/image digest, bucket topology, and the exact probe claim read through the shared checked-in parser. |
