...
def runtime_config(configuration: dict[str, str], profile: str) -> dict[str, str]:
    ...
    for name in (
        ...
        "APNS_SANDBOX_KEY_ID", "ADMIN_USER_IDS", "SIGNUP_LIMIT_PER_DAY", "BASE_URL",
        "WEB_ORIGIN",
        ...
        "PASSWORD_AUTH_MODE", "PASSWORD_AUTH_API_KEY", "PASSWORD_AUTH_PROJECT_ID",
        "PASSWORD_AUTH_TENANT_ID", "VERTEX_PROJECT", "VERTEX_LOCATION", "VERTEX_MODEL",
