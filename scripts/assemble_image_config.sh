...
allowed_keys='KIOKU_BUILD_PROFILE KMS_PROJECT KMS_LOCATION KMS_KEY_RING KMS_KEY GCS_BUCKET GCS_MEDIA_BUCKET GCS_LEGACY_MEDIA_BUCKET RUN_SA_EMAIL ENCLAVE_AUDIENCE ATTEST_STS_AUDIENCE GOOGLE_DESKTOP_CLIENT_ID GOOGLE_IOS_CLIENT_ID GOOGLE_WEB_CLIENT_ID APPLE_TEAM_ID APPLE_KEY_ID APPLE_IOS_CLIENT_ID APPLE_MACOS_CLIENT_ID APPLE_WEB_CLIENT_ID APNS_TEAM_ID APNS_PRODUCTION_KEY_ID APNS_SANDBOX_KEY_ID ALLOWED_EMAILS ADMIN_USER_IDS BASE_URL WEB_ORIGIN BILLING_SERVICE_URL BILLING_SERVICE_AUDIENCE BILLING_ENFORCEMENT_MODE REVIEWER_AUTH_API_KEY REVIEWER_AUTH_UID REVIEWER_AUTH_EMAIL VERTEX_PROJECT VERTEX_LOCATION VERTEX_MODEL ENCLAVE_ACME ENCLAVE_ACME_DIRECTORY ENCLAVE_ACME_CONTACT ARCHIVE_WITNESS_SHADOW_MODE ARCHIVE_WITNESS_PROJECT_ID ARCHIVE_WITNESS_PROJECT_NUMBER ARCHIVE_WITNESS_DATABASE_ID ARCHIVE_V3_SHADOW_RUNTIME_MODE ARCHIVE_V3_ARCHIVE_BUCKET ARCHIVE_V3_ARCHIVE_GCS_PROJECT_NUMBER ARCHIVE_V3_REGISTRY_KMS_VERSION ARCHIVE_V3_WITNESS_PROJECT_ID ARCHIVE_V3_WITNESS_PROJECT_NUMBER ARCHIVE_V3_WITNESS_DATABASE_ID ARCHIVE_V3_ARCHIVE_BINDING_COMMITMENT'
...
for required in KMS_PROJECT KMS_LOCATION KMS_KEY_RING KMS_KEY GCS_BUCKET GCS_MEDIA_BUCKET \
  ...
  GOOGLE_DESKTOP_CLIENT_ID GOOGLE_IOS_CLIENT_ID GOOGLE_WEB_CLIENT_ID ALLOWED_EMAILS \
  ADMIN_USER_IDS BASE_URL WEB_ORIGIN BILLING_SERVICE_URL BILLING_SERVICE_AUDIENCE \
