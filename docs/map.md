...
| [postgresql-schema-releases.md](postgresql-schema-releases.md) | Receipt-bound PostgreSQL expand/finalize ordering, exact morning-email/interrupted-capture/voice-identity companions, voice cohort/pause operator phases, compatibility windows, and writer-activation boundaries |
