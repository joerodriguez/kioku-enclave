...
| [postgresql-schema-releases.md](postgresql-schema-releases.md) | Receipt-bound PostgreSQL expand/finalize ordering, exact morning-email/interrupted-capture companions, compatibility windows, and writer-activation boundaries |
