...
| [ADR-0042](0042-postgresql-only-structured-state.md) | PostgreSQL is the sole structured-state implementation; GCS remains only for live encrypted media bytes, and alternate-backend/migration machinery is removed. |
