...
| `.github/workflows/` | CI, CodeQL/dependency checks, image build/scan, provenance/SBOM attestations, and the signed schema-v5 Phase-0 dual-media-bucket release-manifest subject |
