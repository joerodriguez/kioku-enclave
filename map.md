...
| [migrations/](migrations/map.md) | Append-only PostgreSQL schema migrations for the ADR-0040 structured-state target; applied only by the dedicated release migrator. |
