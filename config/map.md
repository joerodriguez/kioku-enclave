...
| `adr0022-fresh-generation-intent.json` | Canonical provider-free `adr0022-v1` namespace intent. Its exact 1,551 bytes hash to `7ece5ba9…3727`; both fixed schema-10 fresh release roles refuse any content or byte-encoding drift. |
