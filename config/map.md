...
| `adr0022-fresh-generation-intent.json` | Canonical provider-free `adr0022-v1` namespace intent. Its exact 1,551 bytes hash to `7ece5ba9…3727`; schema-10 BOOTSTRAP publication refuses any content or byte-encoding drift. |
