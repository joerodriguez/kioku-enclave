...
- The compiled maintenance importer is the only consumer allowed to turn that sealed
  ...
  It cannot read or settle that drain; detached count/bytes remain reserved
