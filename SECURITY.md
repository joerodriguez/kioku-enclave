...
The inactive resumed-canary stop path has a separate one-shot encrypted-Control
terminal. It exact-binds the released owner and one fixed content-free stop or
comparison-mismatch reason, records `Prepared` before any Store change, retires
