...
`kioku-enclave --derive-voice-eval-assets` verifies those artifacts again and
materializes deterministic canonical WAV/opaque-label pairs plus a receipt in a
separate private output directory.
