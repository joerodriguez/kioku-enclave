...
| `voice_quality.rs` | Versioned enrollment/matching quality policy (quality 1 with the level-relative speech-frame detector 2: floor -50 dBFS, within ~16 dB of the chunk's loud frames, absolute rule kept for steady signals) and best-span selection inside long turns. |
