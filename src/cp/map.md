...
| `media_planner.rs` | Deterministic bounded audio/screen processing work-unit planning, including the fragment-hold policy that keeps a fresh sub-five-second opening segment of an open recording waiting for its first real segment. |
