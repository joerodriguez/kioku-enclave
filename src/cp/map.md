...
| `vertex.rs` | Bounded Vertex Gemini adapter with strict schemas and frozen media-result contract versions (new audio attempts are stamped with the salvaging contract 3), content-free usage metadata, and explicit model routing for separately qualified reconciliation. |
