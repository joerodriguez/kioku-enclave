...
| Path | Responsibility |
|---|---|
| `main.rs` | PostgreSQL-only composition, phase-confirmed schema/activation/erasure migrator plus additive morning-email install, baked configuration, KMS/media construction, TLS, routing, workers, readiness and bounded drain. |
